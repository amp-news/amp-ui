...
in all web browsers. Service worker registration [won't be attempted](src/serviceWorkers.js)
...
starting point, you can make use of the logic included in [`src/serviceWorkers.js`](src/serviceWorkers.js), which
